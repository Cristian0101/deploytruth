...
Use `Cristian0101/deploytruth@v0` for the moving compatible pre-1.0 Action ref, or pin
`Cristian0101/deploytruth@v0.1.0` when a workflow needs an immutable release artifact.
